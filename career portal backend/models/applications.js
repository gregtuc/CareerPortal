...
var createApplication = function (
    ...
    db.query(
      "INSERT INTO applications (applicationId, jobId, userId, title, body, status, dateSent) values (?,?,?,?,?,?,?)",
      [
...
var listApplications = function (callback) {
  ...
  var deleteApplication = function (applicationId, callback) {
    db.query("DELETE FROM applications WHERE applicationId = ?", [applicationId], callback);
  };
